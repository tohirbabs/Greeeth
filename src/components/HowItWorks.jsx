      ...
      <div className="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8 sm:py-24">
        ...
        >
          <div className="w-60 mx-auto shadow-xl">
            <svg height="21" viewBox="0 0 21 21" width="21" xmlns="http://www.w3.org/2000/svg" className="object-cover w-12 h-12 mx-auto text-green-800 hover:text-green-500">
            ...
            <blockquote
              className="flex flex-col justify-between p-4 -mt-2 text-center rounded-lg"
            >
          ...
          <div className="w-60 mx-auto shadow-xl">
            <svg xmlns="http://www.w3.org/2000/svg" className="object-cover w-12 h-12 mx-auto text-green-800 hover:text-green-500" viewBox="0 0 512 512"><title>Leaf</title>
          ...
          <div className="w-60 mx-auto shadow-xl">
            <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 48 48" className="object-cover w-12 h-12 mx-auto text-green-800 hover:text-green-500">
              <mask id="svgIDa">
          ...
          <div className="w-60 mx-auto shadow-xl">
            <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 16 16" className="object-cover w-12 h-12 mx-auto text-green-800 hover:text-green-500">
