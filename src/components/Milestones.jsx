...
export const Milestones = () => {
  ...
  return (
    <div>
      <div class="2xl:container 2xl:mx-auto md:py-12 lg:px-20 md:px-6 px-4 py-9">
        ...
        <div class="relative md:flex justify-center items-center">
          <div class="md:w-4/12 w-full">
            <div class="flex space-x-2 md:mt-0 mt-10">
              <svg
                class="cursor-pointer dark:text-white text-gray-800"
                width="20"
                height="19"
                viewBox="0 0 20 19"
                fill="none"
              ...
              <p class="text-gray-600 text-base dark:text-gray-400 leading-4 font-normal">
                5/5
              </p>
            </div>
            <h3 class="text-gray-800 my-4 dark:text-white font-semibold lg:text-2xl text-xl lg:leading-6 leading-5">
              Based On 170 reviews
            </h3>
            <a
              href="javascript:void(0)"
              class="hover:text-gray-800 dark:text-gray-400 focus:outline-none focus:text-black hover:underline text-sm leading-3 text-gray-600 cursor-pointer"
            >
              See all reviews
            </a>
          </div>

          <div class="hidden md:block relative md:w-8/12 w-full overflow-x-hidden md:mt-0 mt-10">
            <div
              id="slider"
              class="flex justify-start items-start transition ease-out duration-700 gap-4"
            >
              <div class="w-72 flex-none">
                <div class="w-full">
                  ...
                  <div class="md:w-full h-full relative">
                    <p class="text-gray-600 dark:text-gray-400 font-normal text-base leading-7">
              ...
              <div class="w-72 flex-none">
                <div class="w-full">
                  <div class="mb-6 text-gray-800 dark:text-white">
                    <svg
                      width="115"
                      height="24"
                      viewBox="0 0 115 24"
            ...
            <div class="flex justify-end items-end mt-10 pr-2 pb-1">
              <div class="flex items-center space-x-3">
                <button
                  id="prev"
                  aria-label="slide backward"
                  class="text-gray-600 dark:text-gray-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 cursor-pointer"
                >
                  <svg
                    width="40"
                    height="40"
          ...
          <div class="block md:hidden relative md:w-8/12 w-full overflow-x-hidden md:mt-0 mt-10">
            <div
              id="slider2"
              class="flex justify-start items-start transition ease-out duration-700 gap-0 space-x-2"
            >
              <div id="sizeDiv" class="w-full sm:w-6/12 flex-none">
                <div class="w-full">
                  <div class="mb-6">
                    <svg
                      class="text-gray-800 dark:text-white"
              ...
              <div class="w-full sm:w-6/12 flex-none">
                <div class="w-full">
                  <div class="mb-6 text-gray-800 dark:text-white">
                    <svg
                      width="115"
