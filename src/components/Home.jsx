      ...
      <div className="relative max-w-screen-xl px-2 py-2 ml-12 lg:h-screen lg:items-center lg:flex text-white">
        <div className="max-w-xl text-left sm:text-left">
          ...
          <div className="flex flex-wrap gap-4 mt-8 text-center">
            ...
            <a className="block w-1/2 px-12 py-3 text-sm font-medium bg-white rounded shadow text-green-900 sm:w-auto hover:text-rose-700 active:text-rose-500 focus:outline-none focus:ring animate-bounce" href="/about">
              Plant now
            </a>
          </div>
        </div>
