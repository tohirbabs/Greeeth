  ...
  return (
    <div>
      <section className=" grad-lgreen  items-center justify-center  flex flex-col">
        ...
        <div className="lg:max-w-screen-lg mb-40 mt-10 sm:mt-30 mx-4 leading-loose lgreen text-left text-lg">
          ...
          <p className="mt-4">
            ...
            solutions for goods and services more than before. As a result,
            there is a market need for sustainable giving, more specifically,
            for eco-friendly business gifts, which are effective marketing
          ...
          <p className="mt-4">
            ...
            itself is environmentally friendly to whether the business is
            working to restore our earth. You can ensure that your present
            fulfills the brief by selecting a gift that not only considers the
            climate but is also focused on addressing the current climate issue.
          </p>
          <p className="mt-4">
            ...
            plant trees as gifts. Research showing that halting deforestation
            and repairing damaged forests will contribute 30% to resolving the
            climate catastrophe.
          </p>

          <p className="mt-4">
            To meet this increased demand, Greeeth has developed tree-planting
            gifts that allow both customers and staff to join forces and take
            part in group initiatives—by giving trees.
          </p>
        </div>
      </section>
      <Carousel />
